...
function create_stackset_exec_role {
    ...
    $org_account_id = (Get-SSMParameterValue -Name "/kraken/prod-aws/$app_id/org_account_id" –WithDecryption $true).Parameters.Value
...
function add_account_stackset {
    ...
    #>
        ...
        $grafana_url = (Get-SSMParameterValue -Name "/kraken/prod-aws/$app_id/grafana_url" –WithDecryption $true).Parameters.Value
        # -ProfileName prodorganization
        $grafana_token = (Get-SSMParameterValue -Name "/kraken/prod-aws/$app_id/grafana_token" –WithDecryption $true).Parameters.Value
        # -ProfileName prodorganization
